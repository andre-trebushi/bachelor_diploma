...
\begin{figure}[h]
	\hspace{-30pt}		
		...
		\begin{minipage}[h]{0.99\linewidth}
			...
			\end{table}
		\end{minipage}
			\raggedleft{\includegraphics[width=0.9\linewidth]{pic/AA_harm.png}}
	\end{minipage}
	\begin{minipage}[h]{0.49\linewidth}
...
\vspace{-20pt}
\begin{figure}[h]
	\center{\includegraphics[width=0.8\linewidth]{pic/OptScheme.pdf}}
	%Задача: расчёт тепловых нагрузок в первом приближении
\end{figure}
\vspace{-15pt}
\begin{figure}[h]
	\center{\includegraphics[width=0.99\linewidth]{pic/full_spec.pdf}}
\end{figure}
\tiny{\textit{@Andrei Trebushinin ссылка на \href{https://github.com/TrebAndrew/thesis_andrei.git}{GitHub}}}
\end{frame}
