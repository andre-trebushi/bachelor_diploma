...
\begin{figure}[h]
\begin{minipage}[h]{0.49\linewidth}
	\center{Первое предположение}
	\vspace{-10pt}
	\center{\includegraphics[width=0.99\linewidth]{pic/spec_sinc_percent.pdf}}
\end{minipage}	
\end{figure}
...
\begin{figure}[h]
	\begin{minipage}[h]{0.49\linewidth}
		...
		\center{\includegraphics[width=0.99\linewidth]{pic/sim_und_spec_new.pdf}}
	\end{minipage}
	\begin{minipage}[h]{0.49\linewidth}
		\center{Оценка}
		\vspace{-10pt}
...
%{\textit{\href{https://github.com/TrebAndrew/thesis_andrei/tree/dev}}{Тут}}\\
